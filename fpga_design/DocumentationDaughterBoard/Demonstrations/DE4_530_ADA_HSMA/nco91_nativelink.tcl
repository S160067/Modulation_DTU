...
set ipfs_ext "vo"
if {[file exists nco91.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find nco91.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME nco91_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.nco91_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "nco91.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "nco91_tb.${hdl_ext}" -section_id tb -library work
