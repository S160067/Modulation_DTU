...
// Retrieval info:  <NETLIST_SECTION active_core="nco80_st" >
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco80_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco80_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="nco80_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="nco80_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="nco80_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="nco80_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="nco80_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="nco80_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="nco80_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="nco80_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="nco80_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="nco80_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="nco80_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="nco80_sin_f.hex"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="297"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="nco80.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="nco80_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
