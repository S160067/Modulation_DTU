...
// 			lpm_nco10_st
// ============================================================
// Generated by NCO 13.0 [Altera, IP Toolbench 1.3.0 Build 232.1]
// ************************************************************
...
module lpm_nco10 (
	...
	lpm_nco10_st	lpm_nco10_st_inst(
		.phi_inc_i(phi_inc_i),
		.clk(clk),
		.reset_n(reset_n),
		.clken(clken),
...
// Retrieval info: <MEGACORE title="NCO"  version="13.0"  build="232.1"  iptb_version="1.3.0 Build 232.1"  format_version="120" >
// Retrieval info:  <NETLIST_SECTION active_core="lpm_nco10_st" >
...
// Retrieval info:      <PRIVATE name = "devicefamily" value="Cyclone V"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "DPRI" value="5"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "DEVICE" value="CycloneV"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "TARGET" value="CycloneV"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="lpm_nco10_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="lpm_nco10_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="lpm_nco10_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="lpm_nco10_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="lpm_nco10_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="lpm_nco10_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="lpm_nco10_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="lpm_nco10_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="lpm_nco10_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="lpm_nco10_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="lpm_nco10_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="lpm_nco10_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="lpm_nco10_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="lpm_nco10_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="1792"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="1792"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="1623"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="5376"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="1"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_DSP_BLOCKS" value="2"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="lpm_nco10.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="lpm_nco10_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "quartus_settings">
// Retrieval info:      <PRIVATE name = "DEVICE" value="5CGXFC5C6F27C7"  type="STRING"  enable="1" />
