...
if {[file exist "D:/C5G/CD_RecA/CD_RecA/Demonstrations/AD_DA_hsmc/AD_DA_hsmc/C5G_ADA/V/lpm_nco.mpf"] == 0} {
  project new [pwd] lpm_nco
} else	{
project open lpm_nco
}
...
vlog lpm_nco.vo
vlog lpm_nco_tb.v
vsim -L lpm -L altera_mf -L sgate -novopt lpm_nco_tb
do lpm_nco_wave.do
run 22000 ns
