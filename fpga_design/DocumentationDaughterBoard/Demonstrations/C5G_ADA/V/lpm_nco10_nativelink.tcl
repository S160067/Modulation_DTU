...
set ipfs_ext "vo"
if {[file exists lpm_nco10.vo]} {
	set hdl_ext "v"
} else {
	puts "Warning: Could not find lpm_nco10.$ipfs_ext!"
}
...
# test bench settings
set_global_assignment -name EDA_DESIGN_INSTANCE_NAME lpm_nco10_inst -section_id tb
set_global_assignment -name EDA_TEST_BENCH_MODULE_NAME work.lpm_nco10_tb -section_id tb

# IPFS file
set_global_assignment -name EDA_IPFS_FILE "lpm_nco10.${ipfs_ext}" -section_id eda_simulation -library work
...
set_global_assignment -name EDA_TEST_BENCH_FILE "lpm_nco10_tb.${hdl_ext}" -section_id tb -library work
