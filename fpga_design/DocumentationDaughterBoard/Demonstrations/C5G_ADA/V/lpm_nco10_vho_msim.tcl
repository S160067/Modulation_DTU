...
if {[file exist "D:/C5G/CD_RecA/CD_RecA/Demonstrations/AD_DA_hsmc/AD_DA_hsmc/C5G_ADA/V/lpm_nco10.mpf"] == 0} {
  project new [pwd] lpm_nco10
} else	{
project open lpm_nco10
}
...
vcom -93 lpm_nco10.vho
vcom -93 lpm_nco10_tb.vhd
vsim -novopt lpm_nco10_tb
do lpm_nco10_wave.do
run 22000 ns
