...
// Retrieval info:  <NETLIST_SECTION active_core="nco91_st" >
...
// Retrieval info:      <PRIVATE name = "APRI" value="24"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "MODULE_NAME" value="nco91_st"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NETLIST_FILE_NAME" value="nco91_st.v"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "RCFC" value="nco91_cos_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVC" value="nco91_cos_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHC" value="nco91_cos_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCFF" value="nco91_cos_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCVF" value="nco91_cos_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RCHF" value="nco91_cos_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFC" value="nco91_sin_c.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVC" value="nco91_sin_c.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHC" value="nco91_sin_c.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSFF" value="nco91_sin_f.mif"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSVF" value="nco91_sin_f.v"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RSHF" value="nco91_sin_f.hex"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXC" value="53248"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "MAXF" value="53248"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWC" value="12"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RAWF" value="12"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWC" value="4096"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RNWF" value="4096"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "RDW" value="13"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_LCELLS" value="1463"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_MEM_BITS" value="159744"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "NUM_EABS" value="18"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="nco91.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "greybox">
// Retrieval info:      <PRIVATE name = "filename" value="nco91_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
